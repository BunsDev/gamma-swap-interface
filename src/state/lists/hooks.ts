...
import GAMMA_TOKEN_LIST from "../../constants/token-lists/tau.tokenlist.json"
...
const TRANSFORMED_DEFAULT_TOKEN_LIST = listToTokenMap(updateAddresses(GAMMA_TOKEN_LIST) as any)

function updateAddresses(tokenList: any) {
    tokenList.tokens[0].address = DEPLOYMENTS.tokens.wFTM // wFTM
    ...
    tokenList.tokens[5].address = DEPLOYMENTS.tokens.GAMMA // GAMMA
