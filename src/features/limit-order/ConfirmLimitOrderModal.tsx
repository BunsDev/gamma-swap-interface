        ...
        <div className="py-8">
            <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-3">
                    <div className="text-white text-xl font-bold">{`You Pay:`}</div>
                ...
                <div className="bg-dark-800 rounded flex justify-between py-3 px-5">
                    <span className="text-secondary font-bold">{`Rate`}</span>
    ...
    return (
        <div className="bg-dark-800 py-8 -m-6 px-6 flex flex-col gap-6">
            <div className="flex flex-col gap-1">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-secondary">{`Order Expiration`}</span>
