                ...
                {completed.loading ? (
                    ...
                    <>
                        <div className="grid grid-flow-col grid-cols-3 md:grid-cols-4 gap-4 px-4 pb-4 text-sm text-secondary font-bold">
                            <div className="flex items-center cursor-pointer hover:text-primary">{`Receive`}</div>
                            <div className="flex items-center cursor-pointer hover:text-primary">{`Pay`}</div>
                            <div className="flex items-center cursor-pointer hover:text-primary text-left hidden md:block">
                                {`Rate`}
                            </div>
                            <div className="flex items-center cursor-pointer hover:text-primary justify-end">{`Filled`}</div>
                        </div>
