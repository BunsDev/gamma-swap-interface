...
export function AdvancedSwapDetails({ trade, allowedSlippage, minerBribe }: AdvancedSwapDetailsProps) {
    ...
    return !trade ? null : (
        <div className="flex flex-col space-y-2">
            ...
            <RowBetween>
                <RowFixed>
                    <div className="text-sm text-secondary">{`Trading Fee`}</div>
                    <QuestionHelper text={`A portion of each trade (0.25%) goes Solarbeam Treasury.`} />
                </RowFixed>
                <div className="text-sm font-bold text-high-emphesis">
                    {realizedLPFee
          ...
          {realizedLPFee ? `${realizedLPFee.divide(6).toSignificant(4)} ${realizedLPFee.currency.symbol}` : '-'}
            ...
            <RowBetween>
                <RowFixed>
                    ...
                    <QuestionHelper text={`Slippage tolerance`} />
                </RowFixed>
            ...
            {minerBribe && (
                <RowBetween>
                    <RowFixed>
                        ...
                        <QuestionHelper text={`Tip to encourage miners to select this transaction.`} />
                    </RowFixed>
                    <div className="text-sm font-bold text-high-emphesis">
