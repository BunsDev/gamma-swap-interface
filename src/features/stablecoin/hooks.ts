...
import {
    useGammaDistributorContract,
    useBNBPairContract,
    useSolarMovrContract,
    useGammaVaultContract,
} from "../../hooks"
...
export function useUserInfo(farm, token) {
    ...
    const contract = useGammaVaultContract()
...
export function usePositions() {
    return useSolarPositions(useGammaVaultContract())
}
...
export function useVaults() {
    return useSolarVaults(useGammaVaultContract())
}
...
export function useSolarVaultInfo() {
    return useVaultInfo(useGammaVaultContract())
}
