...
import { GAMMA_DISTRIBUTOR_ADDRESS, MINICHEF_ADDRESS } from "../../constants/addresses"
...
const FarmListItem = ({ farm }) => {
    ...
    const [approvalState, approve] = useApproveCallback(typedDepositValue, GAMMA_DISTRIBUTOR_ADDRESS[chainId])
