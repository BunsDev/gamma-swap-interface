...
export function useChefContract(chef: Chef) {
    const solarDistributorContract = useGammaDistributorContract()
...
export function usePositions() {
    return useSolarPositions(useGammaDistributorContract())
}
...
export function useFarms() {
    return useTauFarms(useGammaDistributorContract())
}
