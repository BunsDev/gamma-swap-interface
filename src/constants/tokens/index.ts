...
export const FANTOM_TESTNET: { [key: string]: Token } = {
    wFTM: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.wFTM, 18, "wFTM", "Wrapped FTM"),
    GAMMA: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.GAMMA, 18, "GAMMA", "Gamma Token"),
    DCT: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.FANTOM_TESTNET, getDeployedAddresses().tokens.DIB, 18, "DIB", "Dib Token"),
}
...
export const SOLAR_ADDRESS = {
    ...
    [ChainId.FANTOM_TESTNET]: deployments.tokens.GAMMA,
}

export const SOLAR: ChainTokenMap = {
    [ChainId.FANTOM_TESTNET]: new Token(
        ChainId.FANTOM_TESTNET,
        SOLAR_ADDRESS[ChainId.FANTOM_TESTNET],
        18,
        "GMA",
        "Gamma Token"
    ),
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
    ...
    [SupportedChainId.FANTOM_TESTNET]: new Token(ChainId.FANTOM_TESTNET, deployments.tokens.wFTM, 18, "wFTM", "wFTM"),
}
