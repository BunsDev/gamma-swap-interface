...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
    ...
    [ChainId.FANTOM_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM_TESTNET]],
}
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
    ...
    [ChainId.FANTOM_TESTNET]: deployments.swap.GammaFactory,
    [ChainId.XDC_MAINNET]: "",
}
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
    ...
    [ChainId.FANTOM_TESTNET]: deployments.swap.GammaRouter02,
    [ChainId.XDC_MAINNET]: "",
}
