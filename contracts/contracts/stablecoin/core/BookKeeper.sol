...
/// @title BookKeeper
/** @notice A contract which acts as a book keeper of the Tau Stablecoin protocol. 
    ...
    ICagable 
{
    ...
    struct Position {
        ...
        uint256 debtShare; // The debt share of this position or the share amount of minted Tau Stablecoin [wad]
    }
