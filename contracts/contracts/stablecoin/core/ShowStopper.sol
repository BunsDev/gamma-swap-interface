...
contract ShowStopper is PausableUpgradeable, IShowStopper {
    ...
    /** @dev Start the process of emergency shutdown. The following will happen in order:
            ...
            - BookKeeper will be paused: locking/unlocking collateral and mint/repay Tau Stablecoin will not be allow for any positions
    ...
    */
    ...
    /** @dev Calculate the redeemStablecoin price of the collateral pool id.
            The redeemStablecoin price is the price where the Tau Stablecoin owner will be entitled to cagedTimestamp redeeming from Tau Stablecoin -> collateral token.
