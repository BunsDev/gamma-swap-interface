...
import "../interfaces/IGammaDistributorV2.sol";
import "../libraries/BoringERC20.sol";

/**
 * This is a sample contract to be used in the GammaDistributorV2 contract for partners to reward
...
contract SimpleRewarderPerSec is IRewarder, Ownable, ReentrancyGuard {
    ...
    IGammaDistributorV2 public immutable distributorV2;
    ...
    modifier onlyDistributorV2() {
        require(
            ...
            "onlyDistributorV2: only GammaDistributorV2 can call this function"
        );
        _;
    }
    ...
    constructor(
        ...
        IGammaDistributorV2 _distributorV2,
        uint256 _pid,
        bool _isNative
    ) {
        require(
        ...
        require(
            ...
            "constructor: GammaDistributorV2 must be a valid contract"
        );
    ...
    /// @notice Function called by GammaDistributorV2 whenever staker claims SOLAR harvest. Allows staker to also receive a 2nd reward token.
    /// @param _user Address of user
    /// @param _lpAmount Number of LP tokens the user has
    function onTauReward(address _user, uint256 _lpAmount)
        external
        override
        onlyDistributorV2
        nonReentrant
